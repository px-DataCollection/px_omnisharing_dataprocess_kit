...
The detection model weights (`*.pt`) is distributed under a proprietary license:
- **Non-commercial use**: Free for research and education
- **Commercial use**: Requires paid license
- Contact: mkt@paxini.com
...
## Source Code
The source code for the binary package and any runtime components are proprietary and not publicly available.    
